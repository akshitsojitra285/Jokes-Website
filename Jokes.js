let arr = ["What do dentists call their x-rays? Tooth pics!",
    ...
    "Did you hear the one about ……the salamander who went to Hollywood to make newt movies?",
    "Did you hear the one about ……the New York Jets cocktail? Drink two of them and you’ll forget what your Namath.",
    "Did you hear the one about ……the cow that ate bluegrass and mooed indigo?",
    "Did you hear the one about ……the veterinarian who prescribes birth-control pills for dogs? It’s part of an anti-litter campaign.",
...
function jokefunction() {
    ...
    let joke = Math.floor(Math.random()*(max-min+1))+min;
    document.getElementById("lafing").innerHTML = arr[joke];
